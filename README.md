...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/napari-sam4is-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/napari-sam4is-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add napari-sam4is
# for installing globally
pixi global install napari-sam4is
```
...
It is possible to list all of the versions of `napari-sam4is` available on your platform:
...
```
pixi search napari-sam4is --channel conda-forge
```
